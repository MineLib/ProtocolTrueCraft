...
namespace ProtocolTrueCraft.IO
{
    ...
    public sealed class TrueCraftDataReader : IProtocolDataReader
    {
        private readonly Stream _stream;
        private readonly Encoding _encoding = Encoding.BigEndianUnicode;

        public TrueCraftDataReader(Stream stream)
        {
            _stream = stream;
        }

        public TrueCraftDataReader(byte[] data)
        {
